...
const (
	Greeting_Hello_FullMethodName = "/services.Greeting/Hello"
)
...
func (c *greetingClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, Greeting_Hello_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGreetingServer) Hello(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _Greeting_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeting_Hello_FullMethodName,
	}
